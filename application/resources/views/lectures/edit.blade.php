...
@section('content')
    ...
    <form method="post" action="{{ route('courses.lectures.update', [ $course->id,$lecture->id]) }}">
        ...
        <div class="form-group">
            ...
            <input id="start_datetime" name="start_datetime" autocomplete="off" class="form-control datetime" aria-describedby="nameHelpBlock" value="{{$lecture->start_datetime }}" required="required" type="text">
            <span id="nameHelpBlock" class="form-text text-muted">start date</span>
        </div>

        <div class="form-group">
            <label for="end_datetime">End datetime</label>
            <input id="end_datetime" name="end_datetime" autocomplete="off" class="form-control datetime" aria-describedby="nameHelpBlock" value="{{ $lecture->end_datetime }}" required="required" type="text">
